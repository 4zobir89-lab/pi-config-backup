# Repository Operating Instructions (تعليمات تشغيل المستودع)

> هذا الملف **مكمّل** لتعليمات ECC الموجودة في `AGENTS.md`، ولا يستبدلها.
> اقرأه قبل أي عمل داخل المستودع أو قبل تطبيق أي مزامنة.
> المصدر الأصلي: `AGENTS.md` في جذر المستودع.
